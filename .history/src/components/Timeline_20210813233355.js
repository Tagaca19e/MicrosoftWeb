  ...
  return (
    <VerticalTimeline className="timeline" id="experience">
      ...
      >
        ...
        <p1>
          Built the client side for a Microgrid application that allows energy
          users to obtain security and potential cost savings. Created site
          structure, navigation, page optimization, and graphics integration
          using ReactJS framework with the use of the MVC architecture which
